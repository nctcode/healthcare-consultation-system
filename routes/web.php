...
$router->any('receptionist/appointments/create', 'ReceptionistController@createAppointment');
...
$router->any('receptionist/queue', 'ReceptionistController@queue');

// ==========================================
// PAYMENT GATEWAY MOCK ROUTES
// ==========================================
$router->get('payment-gateway/mock/{id}', 'PaymentGatewayController@mock');
$router->get('payment-gateway/callback', 'PaymentGatewayController@callback');
